            ...
            <footer className="main-footer">
                <section className="main-footer-top">
                    ...
                    <div className="main-footer-top-item">
                        ...
                        <p><a href="cybersoft.edu.vn" target="_blank" rel="noopener noreferrer">{svg.plane} thanhluat1903@gmail.com</a></p>
                    </div>

                    <div className="main-footer-top-item">
                        <h3 className="main-footer-top-item__title">Phone Number:</h3>
                        <p> {svg.phone} 0764-933-597</p>
                    </div>

                    <p className="main-footer-top-copyright">Copyright &copy;2020<br /> Coded and designed by  <a className="glitch glitch1" data-text="Thành Luật Nguyễn"href="https://www.facebook.com/luat.thanh.39" target="_blank" rel="noopener noreferrer"> {svg.hacker}  Nguyễn Thành Luật</a></p>
